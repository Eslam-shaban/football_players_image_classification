...
function init() {
    ...
    dz.on("complete", function (file) {
        ...
        $.post(url, {
            ...
            /* 
            Below is a sample response if you have two faces in an image lets say ronaldo and messi together.
            ...
            */
            ...
            // let players = ["lionel_messi", "cristiano_ronaldo", "nymar_jr", "mo_salah", "zlatan"];
