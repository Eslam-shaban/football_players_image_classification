...
def classify_image(image_base64_data, file_path=None):
    ...
    for img in imgs:
        ...
        print("here from: 'classify_image'")
        print("model: ",__model.predict(final)[0])
    return result
...
def get_cv2_image_from_base64_string(b64str):
    ...
    print("here from:- 'get_cv2_image_from_base64_string'")
    return img
...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    ...
    print("here from:-  'get_cropped_image_if_2_eyes' ")
    cropped_faces = []
